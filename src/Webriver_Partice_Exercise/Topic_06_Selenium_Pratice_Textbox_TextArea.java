...
public class Topic_06_Selenium_Pratice_Textbox_TextArea {
	...
	String employee_id = "AFC" + rand.nextInt(999);
	...
	public void TC_02_Create_Employee() {
		...
		//Step 5
		WebElement value_firstname = driver.findElement(By.name("firstName"));
		WebElement value_middlename = driver.findElement(By.name("middleName"));
		WebElement value_lastname = driver.findElement(By.name("lastName"));
		...
		Assert.assertEquals(value_firstname.getAttribute("value"), "Automation");
		Assert.assertEquals(value_middlename.getAttribute("value"), "Test");
		Assert.assertEquals(value_lastname.getAttribute("value"), "FC");
		...
		sleepfunction(3);
		//Step 12
		Assert.assertEquals(txt_passportNum.getAttribute("value"), passport_num);
		Assert.assertEquals(tat_comment.getAttribute("value"), "Automation test comment");
